...
export class LoginComponent implements OnInit {
  ...
  ngOnInit() {
    this.loginForm = new FormGroup({
      ...
      password: new FormControl(null, [Validators.required, Validators.minLength(8), Validators.maxLength(20), Validators.pattern(this.passReg)])
    });
  }
  ...
  doLogin() {
    ...
    if(this.dataService.authenticateUser(this.loginForm.get('userName').value,this.loginForm.get('password').value)) {
